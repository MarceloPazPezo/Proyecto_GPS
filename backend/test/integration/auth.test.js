...
// T: Lista de pruebas de INTEGRACIÓN sugeridas para el flujo de Autenticación
// ===============================================================================
// Pruebas del Servicio de Autenticación (AuthService)
// ===============================================================================
// --- Lógica de Login Exitosa ---
// 1.1.1 Debe autenticar al usuario y devolver un token si el email y la contraseña son correctos
// 1.1.2 Debe encontrar al usuario sin importar si el email se envía con mayúsculas o minúsculas

// --- Lógica de Login Fallida ---
// 1.2.1 Debería fallar si el email no existe en la base de datos
// 1.2.2 Debería fallar si el email existe pero la contraseña es incorrecta
// 1.2.3 Debería fallar si se intenta autenticar a un usuario sin contraseña (caso borde)

// --- Lógica de Generación de Token (JWT) ---
// 1.3.1 El token devuelto debe ser un string no vacío
// 1.3.2 El token (JWT) decodificado debe contener los datos correctos del usuario (ej: id, email, rol)

const JWT_SECRET = "este-es-un-secreto-para-pruebas";
...
describe("Pruebas de Integración para AuthService", () => {
  ...
  describe("Lógica de Login Fallida", () => {
    ...
    it("1.2.3 Debería devolver un error si se intenta autenticar con contraseña vacía (caso borde)", async () => {
      await createTestUser({
