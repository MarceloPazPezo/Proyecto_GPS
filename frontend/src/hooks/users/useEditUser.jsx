...
const useEditUser = (setUsers) => {
    ...
    const handleUpdate = async (updatedUserData) => {
        if (updatedUserData.idCarrera === null || updatedUserData.idCarrera === '' || updatedUserData.idCarrera === undefined) {
            delete updatedUserData.idCarrera;
        } else {
            updatedUserData.idCarrera = Number(updatedUserData.idCarrera);
        }
        if (updatedUserData) {
            try {
