...
/**
 * Componente de importación de usuarios completamente nuevo
 * Arquitectura limpia sin useEffect problemáticos
 */
const ImportUsersPopup = ({ show, setShow, onFile, loading = false }) => {
  // Estados principales
                    ...
                    <div className="w-full">
                      ...
                      <div className="grid grid-cols-3 gap-3 max-w-3xl mx-auto">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                          ...
                          <div className="space-y-1">
                            <div className="text-sm text-green-600">• Rol</div>
                          </div>
                        </div>
                        
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                          <div className="text-sm font-medium text-yellow-700 mb-2">Condicionales</div>
                          <div className="space-y-1">
                            <div className="text-sm text-yellow-600">• Carrera</div>
                          </div>
                        </div>
                      </div>
                                  ...
                                  <div className="flex flex-col gap-1">
                                    {field === 'rol' ? (
                                      ...
                                      <input
                                        ...
                                        placeholder={
                                          field === 'idCarrera' ? 'ID Carrera (opcional)' :
