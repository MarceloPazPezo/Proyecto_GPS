...
export default function CreateMiUsuarioPopup({ show, setShow, dataUsers }) {
    ...
    const handleSubmit = async (createdUserData) => {
        if (createdUserData) {
            // Forzar idCarrera a número si viene como string
            if (createdUserData.idCarrera) {
                createdUserData.idCarrera = Number(createdUserData.idCarrera);
            }
            try {
                const response = await createMiUsuario(createdUserData);
                            ...
                            <Form
                                ...
                                fields={[
                                    ...
                                    },
                                    {
                                        ...
                                        onChange: (e) => handleInputChange('idCarrera', e.target.value),
                                    },
                                    {
                                        label: (
...
CreateMiUsuarioPopup.propTypes = {
